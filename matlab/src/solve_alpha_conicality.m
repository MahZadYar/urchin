function alpha = solve_alpha_conicality(r_base, r_tip, z_base, z_seam)
%SOLVE_ALPHA_CONICALITY Compute the cone half-angle ensuring G1 continuity.
%   alpha = SOLVE_ALPHA_CONICALITY(r_base, r_tip, z_base, z_seam) solves for
