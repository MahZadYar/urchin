function insideFn = makeInsideTester(mesh, volAlpha)
%MAKEINSSIDETESTER Build a robust point-in-mesh tester closure.
%   insideFn = MAKEINSSIDETESTER(mesh, volAlpha) returns a function handle
