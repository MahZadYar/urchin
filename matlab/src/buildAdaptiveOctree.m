function leaves = buildAdaptiveOctree(bmin, bmax, dxMax, dxMin, blockSize, insideFn, criterion)
%BUILDADAPTIVEOCTREE Construct a sparse octree of voxel blocks.
%   leaves = BUILDADAPTIVEOCTREE(bmin, bmax, dxMax, dxMin, blockSize,
