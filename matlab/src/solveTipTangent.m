function [rTipSeam, alphaCone, zTipSeam, isValid] = solveTipTangent(rBase, coreRadius, zTipCenter, tipSphereRadius)
%SOLVETIPTANGENT Compute tangency between a cone and spherical tip.
%   [rTipSeam, alphaCone, zTipSeam, isValid] = solveTipTangent(rBase, coreRadius,
